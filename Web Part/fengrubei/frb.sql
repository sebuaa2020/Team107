...
CREATE TABLE `results`  (
  ...
  CONSTRAINT `results_ibfk_2` FOREIGN KEY (`dataset_id`) REFERENCES `thesys_datasets` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for thesys_datasets
-- ----------------------------
DROP TABLE IF EXISTS `thesys_datasets`;
CREATE TABLE `thesys_datasets`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '数据集名称或描述',
...
-- ----------------------------
-- Records of thesys_datasets
-- ----------------------------
INSERT INTO `thesys_datasets` VALUES (1, '数据集1', '/datasets/1', 1);
INSERT INTO `thesys_datasets` VALUES (2, '数据集2', '/datasets/2', 2);
INSERT INTO `thesys_datasets` VALUES (3, '数据集3', '/datasets/3', 3);
...
INSERT INTO `thesys_notice` VALUES (13, '12313', 'aaaaaaabbb', '2020-02-24 07:19:55', '超级管理员');
...
INSERT INTO `thesys_permission` VALUES (6, 2, 'menu', '账号管理', NULL, '&#xe628;', '/sys/toUserManager', '', 0, 6, 1);
INSERT INTO `thesys_permission` VALUES (7, 2, 'menu', '角色管理', NULL, '&#xe651;', '/aa/a', '', 0, 7, 1);
...
INSERT INTO `thesys_permission` VALUES (10, 3, 'menu', '数据集管理', NULL, '&#xe756;', '/bus/toDatasetManager', '', 0, 10, 1);
...
INSERT INTO `thesys_permission` VALUES (14, 4, 'menu', '数据集管理', NULL, '&#xe770;', '/sys/toDatasetManager', '', 0, 14, 1);
...
INSERT INTO `thesys_permission` VALUES (92, 3, 'menu', '项目面板', 'goods:create', '&#xe65b;', '/bus/toProjectManagerPanel', NULL, 0, 80, 1);
...
-- ----------------------------
INSERT INTO `thesys_project` VALUES (1, 0, '项目总览', 1, '项目总览', '深圳', 1, 1, '2019-04-10 14:06:32');
INSERT INTO `thesys_project` VALUES (2, 1, '回归任务', 1, '回归任务', '武汉', 1, 2, '2019-04-10 14:06:32');
...
INSERT INTO `thesys_project` VALUES (5, 1, '聚类问题', 0, '聚类问题', '武汉', 1, 5, '2019-04-10 14:06:32');
INSERT INTO `thesys_project` VALUES (6, 1, '数据降维', 0, '数据降维', '武汉', 1, 6, '2019-04-10 14:06:32');
INSERT INTO `thesys_project` VALUES (7, 2, '回归问题1', 0, '回归问题1', '武汉', 1, 7, '2019-04-10 14:06:32');
INSERT INTO `thesys_project` VALUES (8, 3, '分类问题1', 0, '分类问题1', '11', 1, 8, '2019-04-10 14:06:32');
INSERT INTO `thesys_project` VALUES (9, 4, '异常检测1', 0, '异常检测1', '222', 1, 9, '2019-04-10 14:06:32');
INSERT INTO `thesys_project` VALUES (10, 5, '聚类问题1', 0, '聚类问题1', '33', 1, 10, '2019-04-10 14:06:32');
INSERT INTO `thesys_project` VALUES (11, 6, '数据降维1', 1, '数据降维1', '武汉', 1, 11, '2019-04-13 09:49:38');
INSERT INTO `thesys_project` VALUES (21, NULL, 'aaaa', 1, 'aaaa', NULL, NULL, 11, '2020-02-24 07:18:54');
...
INSERT INTO `thesys_user` VALUES (4, '赵六', 'zl', '武汉', 1, '程序员', '2e969742a7ea0c7376e9551d578e05dd', 4, '2018-06-25', 3, 1, 4, 2, '../resources/images/defaultusertitle.jpg', '6480EE1391E34B0886ACADA501E31145');
INSERT INTO `thesys_user` VALUES (5, '孙七', 'sq', '武汉', 1, '程序员', '47b4c1ad6e4b54dd9387a09cb5a03de1', 2, '2018-06-25', 4, 1, 5, 2, '../resources/images/defaultusertitle.jpg', 'FE3476C3E3674E5690C737C269FCBF8E');
INSERT INTO `thesys_user` VALUES (6, '刘八', 'lb', '深圳', 1, '程序员', 'bcee2b05b4b591106829aec69a094806', 4, '2018-08-06', 3, 1, 6, 2, '../resources/images/defaultusertitle.jpg', 'E6CCF54A09894D998225878BBD139B20');
